<template>
	<view class="content">
		<view class="search-box">
			...
			<mSearch class="mSearch-input-box" :mode="1" button="inside" :placeholder="defaultKeyword" @search="doSearch(false)"
			 @input="inputChange" @confirm="doSearch(false)" v-model="keyword" @active='activefocus'></mSearch>
		...
		<view class="search-keyword" v-show="isactive">
...
<script>
	...
	import mSearch from 'framework/components/mehaotian/index'
	export default {
		props: {
			determine: {
				type: Function,
